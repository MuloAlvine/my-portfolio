        ...
        <div className="section-center about-center">
          ...
          <article className="about-info">
            ...
            <div className="about-paragraph">
                <p>
                    I am entry level software developer with with a strong understanding of backend and frontend. 
                    I a major in Computer Science and Information System from the University of South Africa 
                    (BSc Science in Computing), I have a good understanding of computer and its related technology, and I am 
